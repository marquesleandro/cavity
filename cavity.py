...
# Quad Element
 ...
 mesh_name = 'malha_cavity_quad.msh'
 equation_number = 3
...
# Cubic Element
 ...
 mesh_name = 'malha_cavity_cubic.msh'
 equation_number = 3
...
if polynomial_option == 1:
 ...
 condition_xvelocity = benchmark_problems.Cavity(nphysical,npoints,x,y)
 ...
 condition_yvelocity = benchmark_problems.Cavity(nphysical,npoints,x,y)
 ...
 condition_streamfunction = benchmark_problems.Cavity(nphysical,npoints,x,y)
 condition_streamfunction.neumann_condition(neumann_edges[3])
 condition_streamfunction.dirichlet_condition(dirichlet_pts[3])
 condition_streamfunction.gaussian_elimination(streamfunction_LHS0,neighbors_nodes)
 # ---------------------------------------------------------------------------------
...
# Quad Element
 ...
 # Applying vx condition
 xvelocity_LHS0 = sps.lil_matrix.copy(M)
 condition_xvelocity = benchmark_problems.QuadCavity(nphysical,npoints,x,y)
 condition_xvelocity.neumann_condition(neumann_edges[1])
 condition_xvelocity.dirichlet_condition(dirichlet_pts[1])
 condition_xvelocity.gaussian_elimination(xvelocity_LHS0,neighbors_nodes)
 vorticity_ibc = condition_xvelocity.ibc
 ...
 # Applying vy condition
 yvelocity_LHS0 = sps.lil_matrix.copy(M)
 condition_yvelocity = benchmark_problems.QuadCavity(nphysical,npoints,x,y)
 condition_yvelocity.neumann_condition(neumann_edges[2])
 condition_yvelocity.dirichlet_condition(dirichlet_pts[2])
 condition_yvelocity.gaussian_elimination(yvelocity_LHS0,neighbors_nodes)
 ...
 # Applying psi condition
 streamfunction_LHS0 = sps.lil_matrix.copy(K)
 condition_streamfunction = benchmark_problems.QuadCavity(nphysical,npoints,x,y)
 condition_streamfunction.neumann_condition(neumann_edges[3])
 condition_streamfunction.dirichlet_condition(dirichlet_pts[3])
 condition_streamfunction.gaussian_elimination(streamfunction_LHS0,neighbors_nodes)
 # ---------------------------------------------------------------------------------
