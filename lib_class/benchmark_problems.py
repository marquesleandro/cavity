...
class Couette:
 ...
 # condition_psi = bc_apply.Poiseuille(mesh.nphysical,mesh.npoints,mesh.x,mesh.y)
 # condition_psi.neumann_condition(mesh.neumann_edges[3])
 # condition_psi.dirichlet_condition(mesh.dirichlet_pts[3])
 # condition_psi.gaussian_elimination(LHS_psi0,mesh.neighbors_nodes)
 # ------------------------------------------------------------------------------------------------------
 ...
 def __init__(_self, _nphysical, _npoints, _x, _y):
  ...
  _self.benchmark_problem = 'Couette'
...
class QuadCouette:
 ...
 def __init__(_self, _nphysical, _npoints, _x, _y):
  ...
  _self.y = _y
  _self.bc = np.zeros([_self.nphysical,1], dtype = float) 
  _self.benchmark_problem = 'Quad Couette'
...
class QuadCavity:
 ...
 def __init__(_self, _nphysical, _npoints, _x, _y):
  ...
  _self.y = _y
  _self.bc = np.zeros([_self.nphysical,1], dtype = float) 
  _self.benchmark_problem = 'Quad Cavity'
